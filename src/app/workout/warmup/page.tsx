...
export default async function WarmupPage() {
  const exercises = await prisma.exercise.findMany({
    where: { workoutDayId: "warmup" },
    orderBy: { orderIndex: "asc" },
  });

  return (
    <div>
      <h1 className="mb-2 text-2xl font-bold text-white">Warm-Up</h1>
      <p className="mb-6 text-sm text-zinc-400">~5 min · Do this before every session</p>
